...
class Venda(models.Model):
    ...
    Produtos1 = models.ManyToManyField('Eletricos', blank=True, null=True, verbose_name='Produtos Eletricos')
    Produtos2 = models.ManyToManyField('Hidraulico', blank=True, null=True, verbose_name='Produtos hidraulicos')
    Produtovid = models.ManyToManyField('Vidro', blank=True, null=True, verbose_name='Vidros')
    Produtotin = models.ManyToManyField('Tinta', blank=True, null=True, verbose_name='Tintas')
    Produtocob = models.ManyToManyField("Coberta", blank=True, null=True, verbose_name='Cobertas')
    Produtofer = models.ManyToManyField('Ferramenta', blank=True, null=True, verbose_name='Ferramentas')
    Produtoilu = models.ManyToManyField('Iluminacao', blank=True, null=True, verbose_name='Iluminação')
    Produtoestru = models.ManyToManyField('Estrutura', blank=True, null=True, verbose_name='Estrutura')
    Produtopis = models.ManyToManyField('Piso', blank=True, null=True, verbose_name='Piso')
